-- Official Supabase Webhooks & Functions Infrastructure Setup
-- Provides supabase_functions.http_request() trigger function powered by pg_net
...
BEGIN;
  ...
  -- Audit trail table for triggered hooks
  ...
  -- Trigger function that forwards table events to Edge Functions via pg_net
  CREATE OR REPLACE FUNCTION supabase_functions.http_request()
    RETURNS trigger
    LANGUAGE plpgsql
    SECURITY DEFINER
    SET search_path = supabase_functions, extensions, net, public
    AS $function$
    DECLARE
      request_id bigint;
      payload jsonb;
